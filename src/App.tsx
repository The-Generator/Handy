...
function App() {
  ...
  const handleAccessibilityComplete = () => {
    if (!isReturningUser) {
      // New user — auto-download Parakeet V3 in the background
      // (download progress shows in the Footer component)
      commands.downloadModel("parakeet-tdt-0.6b-v3").catch((e) => {
